        ...
        <section id={headerItems.home.page}
            ...
            <div className="md:ml-20 sm:ml-12 md:w-1/2">
                ...
                <ScrollLink
                    ...
                    className="bg-cyan-600 bg-gradient-to-r  hover:from-cyan-600 hover:to-gray-400 m-2 p-3 rounded-md inline-block text-lg font-semibold text-gray-100 cursor-pointer"
                    spy={true}
                    smooth={true}
                >Project
                </ScrollLink>
